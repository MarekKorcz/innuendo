...
Route::get('/property/invoice-data/create/{id}', 'PropertyController@invoiceDataCreate');
Route::post('/property/invoice-data/store', 'PropertyController@invoiceDataStore');
Route::get('/property/invoice-data/edit/{id}', 'PropertyController@invoiceDataEdit');
Route::post('/property/invoice-data/update', 'PropertyController@invoiceDataUpdate');
