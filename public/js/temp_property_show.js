$(document).ready(function() 
{
    ...
    $(".delete").on('click', function(event) 
    {
        ...
        let modalFormElement = document.querySelector("div#deleteTempProperty form");
        
        modalFormElement.action = ("http://localhost:8000/temp-property/" + event.target.dataset.temp_property_id);
        
        let modalElement = document.getElementById('deleteTempProperty');
