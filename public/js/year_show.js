$(document).ready(function() 
{
    ...
    $(".delete").on('click', function(event) 
    {
        ...
        let modalFormElement = document.querySelector("div#deleteYear form");
        
        modalFormElement.action = ("http://localhost:8000/year/" + event.target.dataset.year_id);
        
        let modalElement = document.getElementById('deleteYear');
