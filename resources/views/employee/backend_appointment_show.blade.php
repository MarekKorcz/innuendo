...
<div class="container">
    ...
    <div class="row text-center" style="padding: 3rem 0 1rem 0;">
        ...
        <div class="col-4">
            <a class="btn btn-danger delete" style="color: white; margin: 2px;" data-appointment_id="{{$appointment->id}}">
                @lang('common.remove_appointment')
            </a>
            <a class="btn btn-info" style="margin: 2px;" href="{{ URL::to('/employee/backend-appointment/edit/' . $appointment->id) }}">
    ...
    <div class="row text-center" style="padding: 2rem;">
        ...
        <div class="col-10">
            <div class="jumbotron">
                ...
                @else
                    <a class="btn btn-primary" style="margin: 3px;" href="{{ URL::to('/employee/activate-subscription/' . $subscriptionPurchaseId . '/' . $appointment->id) }}">
