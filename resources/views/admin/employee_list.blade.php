        ...
        <nav class="navbar navbar-inverse">
            ...
            <ul class="nav navbar-nav">
                <li style="padding: 5px;">
                    <a href="{{ URL::to('admin/employee/create') }}" class="btn pallet-1-3" style="color: white;">
                        ...
                        <tbody>
                            @foreach($employees as $employee)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn pallet-2-4" style="color: white;" href="{{ URL::to('/admin/employee/show/' . $employee->slug) }}">
                                            @lang('common.show')
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <tbody>
                            @foreach($tempEmployees as $tempEmployee)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn pallet-2-4" style="color: white;" href="{{ URL::to('/admin/temp-user/employee/send-activation-email/' . $tempEmployee->id) }}">
                                            @lang('common.send')
                                        </a>
                                    </td>
                                </tr>
