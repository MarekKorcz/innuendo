                                                ...
                                                @if (count($purchase->substart->workers) > 0)
                                                    <div class="text-center">
                                                        <div id="button-space" style="padding: 1rem;">
                                                            ...
                                                            <a class="btn pallet-2-2" style="color: white;" href="{{ URL::to('boss/worker/appointment/list/' . $substart->id . '/0') }}">
                                                        ...
                                                        <table class="table table-striped table-bordered">
                                                            ...
                                                            @foreach ($purchase->substart->workers as $worker)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a class="btn pallet-2-2" style="color: white;" href="{{ URL::to('boss/worker/appointment/list/' . $substart->id . '/' . $worker['id']) }}">
                                                                            @lang('common.show')
                                                                        </a>
                                                                    </td>
                                                                </tr>                 
