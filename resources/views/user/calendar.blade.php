        ...
        <div id="table-nav-bar">
            <div class="head-tile text-center" style="width: 25%;">
                @if ($availablePreviousMonth && $month->month_number == 1)
                    <a href="{{ URL::to('user/calendar/' . $property->id . '/' . ($year->year - 1) . '/12/' . $current_day) }}">
                        @svg('solid/angle-left')
                    </a>
                @elseif ($availablePreviousMonth)
                    <a href="{{ URL::to('user/calendar/' . $property->id . '/' . $year->year . '/' . ($month->month_number - 1) . '/' . $current_day) }}">
                        @svg('solid/angle-left')
                    </a>
                @endif
            </div>
            ...
            <div class="head-tile text-center" style="width: 25%; padding-top: 30px;">
                @if ($availableNextMonth && $month->month_number == 12)
                    <a href="{{ URL::to('user/calendar/' . $property->id . '/' . ($year->year + 1) . '/1/' . $current_day) }}">
                        ...
                        <tr>
                            <td class="text-center">
                                @if (is_object($days[$i]) && $days[$i] !== null)
                                    <a href="{{ URL::to('user/calendar/' . $property->id . '/' . $year->year . '/' . $month->month_number . '/' . $days[$i]->day_number) }}">
